        ...
        <div class="row">
            ...
            <div class="col-12 my-1">
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="font-weight-bold">Anda telah meminta pencairan dana.
                            <br>Selanjutnya, silahkan menunggu konfirmasi pihak Nganggur.id terkait pencairan dana.
                    </div>
                    @endif
                    @if (!$project->partner->details->bank_id || !$project->partner->details->bank_account ||
                    !$project->partner->details->bank_account_name)
                    <div class="col-12">
                        <p class="font-weight-bold">Anda belum melengkapi informasi rekening.
