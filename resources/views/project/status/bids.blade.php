        ...
        <div class="row">
            ...
            <div class="col-12 my-1">
                ...
                <div class="card border-0 @if (Auth::id()===$project->user_id) cardRipple @endif roundedCorner">
                    ...
                    <a href="{{route('project.bid',['bid'=>$bids->id])}}" class="text-dark">
                        @endif
                        <div class="card-body p-2">
                            <div class="row">
                                <div class="col-2 col-md-1 pr-0">
                                    <img src="{{ $bids->user->details->photo ? $bids->user->details->photo : asset('img/avatar_placeholder.png')}}"
                                ...
                                <div class="col-10 col-md-11">
                                    <div class="row">
                                        <div class="col-8">
                                            ...
                                            <h5 class="font-weight-bold">@currency($bids->budget) / {{$bids->duration}}
                                                hari</h5>
                                        </div>
                                        <div class="col-4">
                                            <h6 class="text-right">
                                                {{\Carbon\Carbon::parse($bids->created_at)->diffForHumans()}}
                                            </h6>
                                        </div>
                                    </div>
                                </div>
