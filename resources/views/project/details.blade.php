...
<div class="container">
    <div class="row align-items-center">
        ...
        @if ($project->user_id===Auth::id() && $project->status_id !== 5)
        ...
        <div class="col-12 text-center my-1">
            ...
            <div class="starrating2 risingstar d-flex justify-content-center flex-row-reverse">
                <input type="radio" id="star5" name="star" value="5"
                    {{$project->review->star === 5 ? 'checked' : 'disabled'}} /><label for="star5"
                    title="5 star"></label>
                <input type="radio" id="star4" name="star" value="4"
                    {{$project->review->star === 4 ? 'checked' : 'disabled'}} /><label for="star4"
                    title="4 star"></label>
                <input type="radio" id="star3" name="star" value="3"
                    {{$project->review->star === 3 ? 'checked' : 'disabled'}} /><label for="star3"
                    title="3 star"></label>
                <input type="radio" id="star2" name="star" value="2"
                    {{$project->review->star === 2 ? 'checked' : 'disabled'}} /><label for="star2"
                    title="2 star"></label>
                <input type="radio" id="star1" name="star" value="1"
                    {{$project->review->star === 1 ? 'checked' : 'disabled'}} /><label for="star1"
                    title="1 star"></label>
            </div>
