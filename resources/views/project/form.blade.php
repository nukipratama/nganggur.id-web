            ...
            <form action="{{route('project.post')}}" method="POST">
                ...
                <div class="form-group row justify-content-center">
                    ...
                    <div class="col-6 pr-1">
                        ...
                        <div class="input-group ">
                            <input id="duration" placeholder="Pengerjaan" type="number"
                                ...
                                value="{{ old('duration') }}{{isset($project->duration) ? $project->duration : ''}}"
                                min="1" style="border-radius:15px 0 0 15px">
                            <div class="input-group-prepend">
                                <div class="input-group-text  font-weight-bold" style="border-radius:0 15px 15px 0">hari
                                </div>
                            </div>
                            @error('duration')
                            <span class="invalid-feedback px-2" role="alert">
                    ...
                    <div class="col-6 pl-1">
                        ...
                        <div class="input-group">
                            <div class="input-group-prepend">
                                <div class="input-group-text font-weight-bold" style="border-radius:15px 0 0 15px">Rp
                                </div>
                            </div>
